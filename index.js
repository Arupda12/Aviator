...
bot.onText(/\/start/,async(msg,match)=>{
    if(!isStart){
        ...
        bot.sendMessage(msg.chat.id,'🤖 USERNAME IS NOT CONNECTED WITH THE SERVER, PLEASE CONTACT @recoverXarup') 
        bot.sendMessage(chatId,'🤖 USERNAME IS NOT CONNECTED WITH THE SERVER, PLEASE CONTACT @recoverXarup')
